...
from Modules.mapping import ai_common_drops
from Modules.display_object import DisplayObject

DROP_COLOR = (255, 255, 255)
DROP_LABEL_COLOR = (255, 255, 255, 255)
...
class AICommonDrop(DisplayObject):
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        All of this data represents an "ai drop". If you want to add more, you will
        ...
        # Generate our drop's info
        self.name = ai_common_drops.get(self.raw_name).get("Name")
    ...
    def _build_text_render(self) -> Label:
        ...
        :rtype: Label
        :return: What text we want displayed next to the drop
        """
        if self.screen_coords:
        ...
        return Label(self.text_str, color=DROP_LABEL_COLOR, x=0, y=0, batch=main_batch)

    def update(self, my_coords: dict):
        """
        A generic method to update all the interesting data about a drop
