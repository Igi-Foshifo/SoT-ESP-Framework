...
from Modules.mapping import statues
...
class Statue(DisplayObject):
    """
    Class to generate information for a statue object in memory
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        All of this data represents a "Statue". If you want to add more, you will
    ...
    def _build_text_render(self) -> Label:
        ...
        :rtype: Label
        :return: What text we want displayed next to the statue
        """
        if self.screen_coords:
            if "Ruby" in self.name:
    ...
    def update(self, my_coords: dict):
        """
        A generic method to update all the interesting data about a statue
        ...
        if self.screen_coords:
            # render statues when under 500m
