...
from data.mapping import outposts
...
class Outpost(DisplayObject):
    """
    Class to generate information for an outpost object in memory
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        All of this data represents a "Outpost". If you want to add more, you will
        ...
        # Generate our Outpost's info
        self.name = outposts.get(self.raw_name).get("Name")
    ...
    def _build_text_render(self) -> Label:
        ...
        :rtype: Label
        :return: What text we want displayed next to the outpost
        """
        if self.screen_coords:
    ...
    def update(self, my_coords: dict):
        """
        A generic method to update all the interesting data about a outpost
