...
from data.mapping import ghrelics
...
class GHRelic(DisplayObject):
    """
    Class to generate information for a gold hunter relic object in memory
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        All of this data represents a "Gold Hunter Relic". If you want to add more, you will
        ...
        # Generate our gold hunter relic's info
        self.name = ghrelics.get(self.raw_name).get("Name")
    ...
    def _build_text_render(self) -> Label:
        ...
        :rtype: Label
        :return: What text we want displayed next to the gold hunter relic
        """
        if self.screen_coords:
    ...
    def update(self, my_coords: dict):
        """
        A generic method to update all the interesting data about a gold hunter relic
