...
from Modules.mapping import animalcontain
from Modules.display_object import DisplayObject

ANIMAL_CONTAINER_COLOR = (255, 255, 255)
ANIMAL_CONTAINER_LABEL_COLOR = (255, 255, 255, 255)
CIRCLE_SIZE = 2  # The size of the indicator circle we want


class AnimalContainer(DisplayObject):
    """
    Class to generate information for an animal container object in memory
    """
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        All of this data represents an "Animal Container". If you want to add more, you will
        ...
        # Generate our animal container's info
        self.name = animalcontain.get(self.raw_name).get("Name")
        ...
        self.color = ANIMAL_CONTAINER_COLOR
    ...
    def _build_text_render(self) -> Label:
        ...
        :rtype: Label
        :return: What text we want displayed next to the animal container
        """
        if self.screen_coords:
            return Label(self.text_str,
                         color=ANIMAL_CONTAINER_LABEL_COLOR,
        ...
        return Label(self.text_str, color=ANIMAL_CONTAINER_LABEL_COLOR, x=0, y=0, batch=main_batch)

    def update(self, my_coords: dict):
        """
        A generic method to update all the interesting data about an animal container
