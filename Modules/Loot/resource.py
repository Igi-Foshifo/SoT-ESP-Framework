...
from data.mapping import resources
from Modules.display_object import DisplayObject

CRATE_COLOR = (255, 255, 255)
CRATE_LABEL_COLOR = (255, 255, 255, 255)
...
class Resource(DisplayObject):
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        All of this data represents a "Resource". If you want to add more, you will
        ...
        # Generate our resource's info
        self.name = resources.get(self.raw_name).get("Name")
    ...
    def _build_text_render(self) -> Label:
        ...
        :rtype: Label
        :return: What text we want displayed next to the resource
        """
        if self.screen_coords:
    ...
    def update(self, my_coords: dict):
        """
        A generic method to update all the interesting data about a resource
