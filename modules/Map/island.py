...
from data.mapping import islands
...
class Island(DisplayObject):
    ...
    def __init__(self, memory_reader, actor_id, address, my_coords, raw_name):
        ...
        All of this data represents an "Island". If you want to add more, you will
        ...
        # Generate our Islands's info
        self.name = islands.get(self.raw_name).get("Name")
    ...
    def _build_text_render(self) -> Label:
        ...
        :rtype: Label
        :return: What text we want displayed next to the island
        """
        if self.screen_coords:
    ...
    def update(self, my_coords: dict):
        """
        A generic method to update all the interesting data about an island
