...
from data.mapping import shipwrecks
...
class Shipwreck(DisplayObject):
    """
    Class to generate information for a shipwreck object in memory
    """
    ...
    def _build_text_render(self) -> Label:
        ...
        return Label(self.text_str, color=SHIPWRECK_LABEL_COLOR,
